local library = loadstring(game:HttpGet('https://raw.githubusercontent.com/DesrtKnock/DesrtKnock-X/refs/heads/main/notification.lua'))()
...
print("索引开启反挂机")
		...
		game:GetService("Players").LocalPlayer.Idled:connect(function()
		   ...
		   vu:Button2Up(Vector2.new(0,0),workspace.CurrentCamera.CFrame)
                ...
                wait(1)
library.prompt('北极星脚本中心', '欢迎使用北极星脚本中心', 10)
...
local Section = Tab:AddSection({	Name = "甩飞"})
...
OPOTab:AddButton({
	Name = "DesrtKnock v1 小玄奘制作/测试版/制作中",
	Callback = function()
     loadstring(game:HttpGet("https://raw.githubusercontent.com/XiaoXuAnZang/XKscript/refs/heads/main/DOORS.txt"))()
  	end    
})
...
Tab:AddButton ({
	Name = "单次传送全图人",
	Callback = function ()
game:GetService("ReplicatedStorage"):WaitForChild("ALLTeleportEvent"):FireServer()
	end
})
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Tab:AddButton ({
	Name = "单次全图杀人",
	Callback = function ()
game:GetService("ReplicatedStorage"):WaitForChild("KillAllEvent"):FireServer()
	end
})
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Tab:AddToggle({
