...
function UICreator:CreateWindow()
    local Window = shared.Library:CreateWindow({
        Title = "mspaint v3| 无需卡密版 | " .. shared.ScriptName,
        Center = true,
        AutoShow = true,
        Resizable = true,
        NotifySide = "Right",
...
function UICreator:CreateSettingsTab()
    ...
    MenuGroup:AddButton("加入MSPAINT的DC", function()
    ...
    CreditsGroup:AddLabel("合作团队:")
    CreditsGroup:AddLabel("汉化作者:R-Exploit")
    CreditsGroup:AddLabel("测试员:NIDO_MUNCISEEK--")   
    CreditsGroup:AddLabel("汉化修补:小玄奘")
    CreditsGroup:AddLabel("警告")
    CreditsGroup:AddLabel("已经有源码的人，不准外传，外传死全家")
    CreditsGroup:AddLabel("知晓人我都知道")
