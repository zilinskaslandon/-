...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『北极星中心』"; Text ="核对用户ID中♨️"; Duration = 2; })
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『北极星中心』"; Text ="用户ID核对完毕♨️"; Duration = 4; })

local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/zilinskaslandon/-/refs/heads/main/jmlibrary1.lua"))();        
local win = ui:new("北极星中心")
--
...
about:Label("北极星中心V2")
about:Label("作者邮箱：zilinskaslandon@gmail.com")
about:Label("QQ主群：985228498")
about:Label("作者：小北")
about:Label("此脚本前身是丁丁的")
...
about:Label("感谢所有支持北极星中心的人")
about:Label("如有bug请上报")
about:Label("♨️")
about:Label("       ")
about:Label("感谢大家支持北极星中心")
...
about:Button("北极星中心[云ui]",function()
